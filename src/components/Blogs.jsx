...
const Blogs = () => {
  ...
  return (
    <>
            ...
            <div className="col-10 mx-auto">
              <div className="row">
                ...
                <p className="subheader my-3 text-center ">
                  ...
                  Find informative and engaging articles which cover a wide
                  range of topics, including SEO, social media, content
                  marketing, and more. Stay up to date and enhance your digital
                  marketing knowledge.
                </p>
                {isAuthenticated && (
      ...
      >
        ...
        <DialogContent>
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group controlId="blogImage" className="mt-5">
      ...
      {/* <Modal
        style={{ scale: "0.9", marginTop: "6rem", borderRadius: "20px" }}
        show={showModal}
        onHide={handleClose}
      ...
      {selectedPostId && (
        <Modal
          ...
          show={selectedPostId !== null}
          onHide={() => handleDeleteAlert(null)}
        >
          <Modal.Body>
              ...
              <div key={blog.id} className="col-md-4">
                <div className="card blogcard">
                  ...
                  <div className="card-body">
                    ...
                    <p
                      className="card-text blogcardpara "
                    ...
                    <p className="card-text">
                      ...
                      <small className="text-white">
                        Time Posted:{" "}
                        {format(blog.createdAt.toDate(), "yyyy-MM-dd HH:mm")}{" "}
                        IST
                      </small>
                    </p>
                    <NavLink
                      to={`/blog/${blog.id}`}
                      type="button"
                      className="btn btn-lg btn-block btn-primary readmore "
                    >
                      {" "}
                      Read More{" "}
                    </NavLink>
                    {isAuthenticated && (
                      <>
                        <button
                          className="btn btn-sm editbtn btn-primary mx-3 "
